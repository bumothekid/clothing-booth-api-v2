...
import uuid
import os
from app.utils.exceptions import ImageUnclear, UnsupportedFileTypeError, FileTooLargeError
...
class ImageManager:
    ...
    def remove_background(self, file: FileStorage) -> tuple:
            try:
                ...
                try:
                    ...
                    raise ImageUnclear("The provided image does not contain a foreground.")
                ...
                return f"/uploads/temp/{fileName}.webp", fileName + ".webp"
    ...
    def move_preview_image_to_permanent(self, filename: str, is_clothing: bool = True) -> str:
        try:
